...
class FrameAnalyser(private var context: Context, private var boundingBoxOverlay: BoundingBoxOverlay)
        ...
        if (isProcessing.get()) {
            ...
            detector.process(inputImage)
                .addOnSuccessListener { faces ->
                    ...
                    Log.d("Model", "analyze faces size " + faces.size.toString())
    ...
    private suspend fun runModel(faces: List<Face>, cameraFrameBitmap: Bitmap) {
        withContext(Dispatchers.Default) {
            ...
            Log.d("Model", "Faces in runModel: " + faces.size.toString())
            for (face in faces) {
                try {
                    Log.d("Model", "runModel")
                    ...
                    Log.d( "Model", "New frame received.")
                    ...
                    Log.d("Model" , "Average score for each user : $nameScoreHashmap")
